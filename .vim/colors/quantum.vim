...
" Color Palette
let s:gray1     = g:quantum_black ? '#212121' : '#121212'
...
let s:gray5     = g:quantum_black ? '#b6c2c3' : '#aebbc5'
let s:gray6     = '#262626'
...
call s:HL('MatchParen',                     s:gray6,    s:white,     'bold')
...
call s:HL('StatusLine',                     s:gray5,    s:gray6,    'none')
call s:HL('StatusLineNC',                   s:gray2,    s:gray4,    '')
call s:HL('TabLine',                        s:gray4,    s:gray2,    'none')
call s:HL('TabLineFill',                    s:gray1,    s:gray2,    'none')
...
call s:HL('WildMenu',                       s:white,    s:gray2,    '')
